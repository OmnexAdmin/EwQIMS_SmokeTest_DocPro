...
public class NewDocumentsRequest extends ProjectMethods {
	...
	private WebElement eleEnterRev;

	@FindBy(how = How.ID, using = "txtKeyword")
	private WebElement eleEnterKW;

	@FindBy(how = How.ID, using = "txtChangesMade")
	private WebElement eleEnterChangesReqd;

	@FindBy(how = How.ID, using = "txtIssueNo")
	private WebElement eleEnterIssueNum;
	...
	private WebElement eleClickOnAddButton;
	   ...
	   @FindBy(xpath="(//img[@id='imgCompleted'])[2]") WebElement eleVerifyUploadCompletes;
	...
	public NewDocumentsRequest uploadNewDocument(String levelName, String documentNumber, String documentName,
			String attachment) throws Throwable {
		...
		// eleAttachDoc.sendKeys("D:\\Bhuvana\\Bhuvana 218 machine backup as of 2nd June
		// 2017\\Bhuvana\\Documents\\Attachments for IC\\Sample Template.doc");

		// WebElement
		// eleAttachDoc=driver.findElementByXPath("//input[@id='fileUploadControl']");
		...
		//scrollDownthePage();
		verifyDisplayed(eleVerifyUploadCompletes,"Upload Status: Completed");
